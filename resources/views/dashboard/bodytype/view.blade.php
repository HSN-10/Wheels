...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">@lang('global.bodyTypes')</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">@lang('global.home')</a></li>
                    <li class="breadcrumb-item active"><span>@lang('global.bodyTypes')</span></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <form>
                                <h4 class="form-section"><i class="fas fa-list"></i> @lang('global.bodyTypes')</h4>
                            </form>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-none d-md-block">
                                                    <div class="btn-group">
                                                        <a href="{{route('bodytype.edit', $bodyType)}}" class="btn btn-group btn-info square">
                                                            <i class="fas fa-edit mr-1"></i> @lang('global.edit')
                                                        </a>
                                                        <a href="" class="btn btn-group btn-danger square confirm-text"
                                                            onclick="event.preventDefault();" data-category="{{$bodyType->id}}">
                                                    ...
                                                    <div class="btn-group mr-1 mb-1">
                                                        ...
                                                        <div class="dropdown-menu" style="right: -150% !important;">
                                                            <a class="dropdown-item"
                                                                href="{{route('bodytype.edit', $bodyType)}}"><i class="fas fa-edit mr-1"></i> @lang('global.edit')</a>
                                                            <a class="dropdown-item confirm-text text-danger" data-category="{{$bodyType->id}}"
                                                                href="" onclick="event.preventDefault();"
                                                            ><i class="fas fa-trash mr-1"></i> @lang('global.delete')</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <form id="delete-form-{{$bodyType->id}}" action="{{route("bodytype.destroy", $bodyType)}}" method="POST" style="display: none;">
                                                    @csrf
