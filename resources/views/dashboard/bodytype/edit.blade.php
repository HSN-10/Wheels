...
@section('title' ,  Lang::get('global.dashboard') . ' | '. Lang::get('global.edit') . " " . Lang::get('global.bodyType'))
@section('content')
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">@lang('global.edit') @lang('global.bodyType')</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><span>@lang('global.edit') @lang('global.bodyType')</span></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{route('bodytype.update', $bodyType->id)}}" method="POST" enctype="multipart/form-data">
                                <h4 class="form-section"><i class="fas fa-list"></i> @lang('global.edit') @lang('global.bodyType')</h4>
                                @csrf
                                ...
                                <div class="row">
                                    <fieldset class="form-group col-4 mb-2">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid text-danger @enderror" id="name"
                                                placeholder="@lang('global.name')" name="name" value="{{$bodyType->name}}">
                                        @error('name')
                                    ...
                                    <div class="col-4">
                                        <img class="rounded img-thumbnail mt-1" width="50%" src="{{ asset('storage/'.$bodyType->icon) }}">
                                    </div>
                                </div>
