...
@section('title' ,  Lang::get('global.dashboard') . ' | '. Lang::get('global.users'))
@section('content')
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><span>@lang('global.users')</span></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <form>
                                <h4 class="form-section"><i class="fas fa-list"></i> @lang('global.users')</h4>
                            </form>
